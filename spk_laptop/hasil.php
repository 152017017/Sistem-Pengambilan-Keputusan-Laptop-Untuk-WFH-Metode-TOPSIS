						...
						<div class="row">
							<div class="card">
								<div class="card-content">
									<h5 style="margin-bottom: 16px; margin-top: -6px;">Matriks Laptop</h5>
									<table class="responsive-table">
										...
										<tbody>
											...
											$no=1;
											while ($spesifikasi=mysqli_fetch_array($query)) {
												$Matrik[$no-1]=array($spesifikasi['harga_angka'],$spesifikasi['layar_angka'],$spesifikasi['kamera_angka'],$spesifikasi['baterai_angka'],$spesifikasi['ram_angka'],$spesifikasi['hdd_angka'],$spesifikasi['processor_angka'] );
												?>
												<tr>
													<td><center><?php echo "A",$no ?></center></td>
													<td><center><?php echo $spesifikasi['harga_angka'] ?></center></td>
													<td><center><?php echo $spesifikasi['layar_angka'] ?></center></td>
													<td><center><?php echo $spesifikasi['kamera_angka'] ?></center></td>
													<td><center><?php echo $spesifikasi['baterai_angka'] ?></center></td>
													<td><center><?php echo $spesifikasi['ram_angka'] ?></center></td>
													<td><center><?php echo $spesifikasi['hdd_angka'] ?></center></td>
													<td><center><?php echo $spesifikasi['processor_angka'] ?></center></td>
												</tr>
												<?php
												$no++;
											}
									...
									<table class="responsive-table">
										...
										<tbody>
											...
											while ($spesifikasi=mysqli_fetch_array($query)) {
												...
												$MatrikNormalisasi[$no-1]=array($spesifikasi['harga_angka']/$pembagiNM[0],
													$spesifikasi['layar_angka']/$pembagiNM[1],
													$spesifikasi['kamera_angka']/$pembagiNM[2],
													$spesifikasi['baterai_angka']/$pembagiNM[3],
													$spesifikasi['ram_angka']/$pembagiNM[4],
													$spesifikasi['hdd_angka']/$pembagiNM[5],
													$spesifikasi['processor_angka']/$pembagiNM[6]);

													?>
													<tr>
														<td><center><?php echo "A",$no ?></center></td>
														<td><center><?php echo round($spesifikasi['harga_angka']/$pembagiNM[0],8)?></center></td>
														<td><center><?php echo round($spesifikasi['layar_angka']/$pembagiNM[1],8) ?></center></td>
														<td><center><?php echo round($spesifikasi['kamera_angka']/$pembagiNM[2],8) ?></center></td>
														<td><center><?php echo round($spesifikasi['baterai_angka']/$pembagiNM[3],8) ?></center></td>
														<td><center><?php echo round($spesifikasi['ram_angka']/$pembagiNM[4],8) ?></center></td>
														<td><center><?php echo round($spesifikasi['hdd_angka']/$pembagiNM[5],8) ?></center></td>
														<td><center><?php echo round($spesifikasi['processor_angka']/$pembagiNM[6],8) ?></center></td>
													</tr>
													<?php
													$no++;
												}
										...
										<table class="responsive-table">
											<thead>
												<tr>
													...
													<th><center>Value Kriteria Baterai</center></th>
													<th><center>Value Kriteria RAM</center></th>
													<th><center>Value Kriteria HDD</center></th>
											...
											<tbody>
												...
												while ($spesifikasi=mysqli_fetch_array($query)) {
													...
													$NormalisasiBobot[$no-1]=array(
														...
														$MatrikNormalisasi[$no-1][5]*$W4,
														$MatrikNormalisasi[$no-1][6]*$W7 );

														?>
														<tr>
															<td><center><?php echo "A",$no ?></center></td>
															<td><center><?php echo round($MatrikNormalisasi[$no-1][0]*$W1,8) ?></center></td>
															<td><center><?php echo round($MatrikNormalisasi[$no-1][1]*$W2,8) ?></center></td>
															<td><center><?php echo round($MatrikNormalisasi[$no-1][2]*$W3,8) ?></center></td>
															<td><center><?php echo round($MatrikNormalisasi[$no-1][3]*$W4,8) ?></center></td>
															<td><center><?php echo round($MatrikNormalisasi[$no-1][4]*$W5,8) ?></center></td>
															<td><center><?php echo round($MatrikNormalisasi[$no-1][4]*$W6,8) ?></center></td>
															<td><center><?php echo round($MatrikNormalisasi[$no-1][4]*$W7,8) ?></center></td>
														</tr>
														<?php
														$no++;
													}
											...
											<table class="responsive-table">
												...
												<tbody>
													...
													<tr>
														...
														<td><center><?php echo(round(max($NormalisasiBobotTrans[0]),8));?>&nbsp(max)</center></td>
														<td><center><?php echo(round(max($NormalisasiBobotTrans[1]),8));?>&nbsp(max)</center></td>
														<td><center><?php echo(round(max($NormalisasiBobotTrans[2]),8));?>&nbsp(max)</center></td>
														<td><center><?php echo(round(max($NormalisasiBobotTrans[3]),8));?>&nbsp(max)</center></td>
														<td><center><?php echo(round(max($NormalisasiBobotTrans[4]),8));?>&nbsp(max)</center></td>
														<td><center><?php echo(round(max($NormalisasiBobotTrans[5]),8));?>&nbsp(max)</center></td>
														<td><center><?php echo(round(max($NormalisasiBobotTrans[6]),8));?>&nbsp(max)</center></td>
													</tr>
													<tr>
														<?php  
														...
														?>
														<td><center><?php echo "Y-" ?> </center></td>
														<td><center><?php echo(round(min($NormalisasiBobotTrans[0]),8));?>&nbsp(min)</center></td>
														<td><center><?php echo(round(min($NormalisasiBobotTrans[1]),8));?>&nbsp(min)</center></td>
														<td><center><?php echo(round(min($NormalisasiBobotTrans[2]),8));?>&nbsp(min)</center></td>
														<td><center><?php echo(round(min($NormalisasiBobotTrans[3]),8));?>&nbsp(min)</center></td>
														<td><center><?php echo(round(min($NormalisasiBobotTrans[4]),8));?>&nbsp(min)</center></td>
														<td><center><?php echo(round(min($NormalisasiBobotTrans[5]),8));?>&nbsp(min)</center></td>
														<td><center><?php echo(round(min($NormalisasiBobotTrans[6]),8));?>&nbsp(min)</center></td>
													</tr>
												</tbody>
											</table>
										</div>
												...
												<tbody>
													...
													while ($spesifikasi=mysqli_fetch_array($query)) {
														...
														<tr>
															...
															<td><center><?php echo round($Dplus[$no-1],8) ?></center></td>
															<td><center><?php echo "D",$no ?></center></td>
															<td><center><?php echo round($Dmin[$no-1],8) ?></center></td>
														</tr>
														<?php
														$no++;
													}
											...
											<table class="responsive-table" >
												...
												<thead style="border-top: 1px solid #d0d0d0;">
													<tr>
														...
														<th></th>
														<th><center>Rekomendasi laptop terpilih</center></th>
														<th></th>
														<th><center>Spesifikasi lengkap</center></th>
													</tr>
												</thead>
												<tbody>
													<tr>
														...
														for ($i=0; $i < count($nilaiV); $i++) { 
															if ($nilaiV[$i] == $testmax) {
																$query=mysqli_query($selectdb,"SELECT * FROM spesifikasi where id_laptop = $i+1");
																?>
																...
																<th></th>
																<td><center><a href="<?php echo $user['url_laptop']; ?>" id="download-button" class="waves-effect waves-light btn" style="margin-top: 0px">Lihat</a><center></td>
																<?php
															}
														}
													} ?>
